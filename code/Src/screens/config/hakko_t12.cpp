...
namespace gui
{
    ...
    void ScreenConfigHakkoT12::OnButtonClick(uint16_t ButtonPin)
    {
        ...
        case 1:
            ...
            _inputInt.SetMin(-10);
            if (_isInputShow[0])
                _inputInt.SetValue(_emem->Param().t12Calibration);
            else
            {
                _emem->Param().t12Calibration = _inputInt.GetValue();
                _emem->Save();
            }
        ...
        case 2:
            ...
            _inputInt.SetMin(50);
            if (_isInputShow[1])
                _inputInt.SetValue(_emem->Param().t12MinTemp);
            else
            {
                _emem->Param().t12MinTemp = _inputInt.GetValue();
                _emem->Save();
            }
        ...
        case 3:
            ...
            _inputInt.SetMin(_emem->Param().t12MinTemp);
            if (_isInputShow[2])
                _inputInt.SetValue(_emem->Param().t12MaxTemp);
            else
            {
                _emem->Param().t12MaxTemp = _inputInt.GetValue();
                _emem->Save();
            }
        ...
        case 5:
            ...
            _inputTime.SetSeconds(_emem->Param().t12TimeSleep[2]);
            _inputTime.SetMinutes(_emem->Param().t12TimeSleep[1]);
            _inputTime.SetHours(_emem->Param().t12TimeSleep[0]);
        ...
        case 6:
            ...
            _inputInt.SetMin(_emem->Param().t12MinTemp);
            if (_isInputShow[4])
                _inputInt.SetValue(_emem->Param().t12TempSleep);
            else
            {
                _emem->Param().t12TempSleep = _inputInt.GetValue();
                _emem->Save();
            }
        ...
        case 8:
            if (!_isInputShow[5])
            {
                _inputSelectNtc.SetActiveItem(_emem->Param().t12Ntc);
                _inputSelectNtc.SetAllItemCheck(false);
                _inputSelectNtc.SetItemCheck(_emem->Param().t12Ntc, true);
                _isInputShow[5] = true;
            }
            else
            {
                ...
                _emem->Param().t12Ntc = _inputSelectNtc.GetActiveItem();
            }
    ...
    void ScreenConfigHakkoT12::OnButtonLongClick(uint16_t ButtonPin)
    {
        ...
        case 5:
            ...
            _inputTime.Visible(false);
            _emem->Param().t12TimeSleep[2] = _inputTime.GetSeconds();
            _emem->Param().t12TimeSleep[1] = _inputTime.GetMinutes();
            _emem->Param().t12TimeSleep[0] = _inputTime.GetHours();
            _emem->Save();
            break;
        case 8:
